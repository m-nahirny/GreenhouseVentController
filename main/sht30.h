...
/**
 * @brief Add device to existing bus
 * @param[in] i2c_master_bus_handle_t I2C bus_handle
* @param[in] _device_address address of the sht30 device.
* @param[in] _scl_speed_hz clock speed of i2c communication.
* @param[in] _scl_wait_us wait time fot timeout of communication.
* @return
...
*      - init_error: Unsuccesfull inicialization of sht30.
*/
sht30_status_t sht30_init_add(i2c_master_bus_handle_t bus_handle, uint8_t _device_address, uint16_t _scl_speed_hz, uint32_t _scl_wait_us);
